...
Lastly, let us review the `anova_check()` function, which allows us to assess the assumptions of a linear model. Consider modeling the bill length of penguins in millimeters using their species, weight, and 
